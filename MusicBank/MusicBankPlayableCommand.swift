//
//  MusicBankPlayableCommand.swift
//  MusicBank
//
...
enum MusicBankPlayableCommand: CaseIterable {
    ...
    func addHandler(_ handler: @escaping (MusicBankPlayableCommand, MPRemoteCommandEvent) -> MPRemoteCommandHandlerStatus) {
